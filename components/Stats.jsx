    ...
    >
      <div className="flex md:flex-row flex-col w-full md:h-full items-center justify-center  md:mx-auto">
        <div className="text-center flex flex-col items-center justify-center md:w-[25%] p-4 md:p-10">
          <span
            id="counter"
            className="text-5xl md:text-9xl font-[200]  text-blue-500"
          ></span>
        ...
        <div className="text-justify  text-lg font-[200] hidden h-full w-[47rem] md:block ">
          ...
          We are a dynamic multimedia production company with{" "}
          <span className="font-bold">
            over 9 years of experience, specialising in documentary filmmaking{" "}
          </span>{" "}
          while also creating impactful content for corporate, branded, news,
          podcast, and music videos.
          <span className="font-bold">
            {" "}
            Our mission is to craft compelling narratives that resonate deeply,{" "}
          </span>
          whether it's capturing the raw authenticity of real-life stories or
          delivering creative productions for brands. At Posted Productions, we
          believe in the power of visuals to inspire, inform, and connect and{" "}
        ...
        <div className="text-center flex flex-col items-center justify-center md:w-[25%] p-4 md:p-10">
          <span
            ...
            className="text-5xl md:text-9xl font-[200]  text-blue-500"
          ></span>
          <h1 className="md:text-2xl text-xl  font-[300]">
      ...
      <div className="flex flex-col md:grid md:grid-cols-3 justify-evenly items-center gap-10 h-full md:h-[40rem] w-full mb-[4rem] ">
        <div className="flex items-center justify-center text-center bg-slate-600 rounded-full overflow-hidden w-[10rem] h-[10rem] md:h-[25rem] md:w-[25rem]">
          <video
            ...
            loop
            muted
            className="object-cover md:w-[50rem] md:h-[50rem]"
            alt="posted productions crew"
          />
        </div>
        <div className="flex  items-center justify-center text-center bg-slate-600 rounded-full overflow-hidden w-[10rem] h-[10rem] md:h-[25rem] md:w-[25rem]">
          <video
      ...
      <h1 className="text-2xl md:text-5xl pt-10 text-blue-600 uppercase text-center">
