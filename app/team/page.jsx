...
const Team = [
  ...
  {
    id: 3,
    url: "/profile-pictures/JaPP.jpeg",
    name: "Ja Abdulla",
    desc: "Ja Abdulla has joined the team as a project manager, assistant producer, and marketing specialist. With a keen interest for storytelling, Ja helps to create powerful and engaging documentary stories. She has assisted on projects for CNA, ARD, NBC and more. Her marketing position makes her in charge of the Posted Productions company, bringing expertise in digital marketing and brand strategy to promote the company's innovative content.",
  },
  {
    id: 4,
...
const page = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Music Video Production and Documentary Filmmakers in Seoul
        </title>
        <meta
          name="description"
          content="Professional music video production and experienced documentary filmmakers in Seoul. High-quality video storytelling tailored to your vision."
        />
        <meta
          name="keywords"
          content="Music video production in Seoul, Documentary filmmakers in Seoul"
        />
        <meta
          property="og:title"
          content="Music Video Production and Documentary Filmmakers in Seoul"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.posted-productions.com/team"
        />
      </Head>
      ...
      >
        <h1 className="text-6xl md:text-7xl text-center pb-[5rem] uppercase">
          Our team
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 ">
          {Team.map((pep) => (
            <motion.div
              ...
              className=" h-[35rem] group pb-10  md:px-10 relative "
              key={pep.id}
            >
              <motion.img
                whileHover={{ scale: 1.1 }}
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center mx-8 text-center text-white">
                <h1 className="hidden absolute group-hover:block text-xl text-blue-400 uppercase font-[300]">
                  Learn More
                </h1>
              </div>
              <h1 className="text-3xl text-center md:text-left footerheader py-10">
                {pep.name}
              </h1>
              {/*   <p>{pep.desc}</p> */}
            </motion.div>
          ...
          >
            ...
            >
              <motion.img
                ...
                whileInView={true}
                src={currentPep.url}
                className="md:h-auto h-[20rem] w-screen md:w-[20rem] object-cover"
                alt={currentPep.name}
              />
              ...
              >
                <h1 className="footerheader text-2xl font-semibold md:text-5xl ">
                  {currentPep.name}
                </h1>
