  ...
  return (
    ...
    transition={{ duration: 1, delay: 0.1 }}
     className='grid grid-cols-1 md:grid-cols-2 py-[12rem] text-xl'>
      ...
      <div className='md:hidden flex py-10 h-[30rem] w-full md:h-full items-center justify-center bg-cover bg-no-repeat bg-[url("https://images.squarespace-cdn.com/content/v1/668baa90a93f73799f48b8ba/1726027163743-QYWYQZGF887V6VLJ475T/unsplash-image-iBEPt9udRz4.jpg?format=2500w")]'>
      ...
      <div className='md:block hidden py-10 w-full h-full items-center justify-center bg-cover bg-no-repeat bg-[url("https://images.squarespace-cdn.com/content/v1/668baa90a93f73799f48b8ba/1726027163743-QYWYQZGF887V6VLJ475T/unsplash-image-iBEPt9udRz4.jpg?format=2500w")]'>
        <h1 className='text-4xl md:text-7xl text-white font-bold'>FILMING</h1>
      </div>

      <div className='md:hidden flex py-10 h-[30rem] w-full md:h-full items-center justify-center bg-cover bg-no-repeat bg-[url("https://images.squarespace-cdn.com/content/v1/668baa90a93f73799f48b8ba/1726027199352-EYD3D2QN7HWL879V5CO6/unsplash-image-U4-_lvnjkd8.jpg?format=2500w")]'>
        <h1 className='text-4xl md:text-7xl text-white font-bold'>FILMING</h1>
      </div>
