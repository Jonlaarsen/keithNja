      ...
      >
        <div>
          <div className="md:pl-5 ">
            <h1 className=" text-5xl md:text-8xl px-4 font-bold  md:pb-[2rem]">
              CONTACT US
            </h1>
            <p className=" text-xl font-[300] px-5 w-[90%] pb-[1rem]">
              Interested in working with us? <br /> Fill out some info and we
          ...
          <form
            ...
            action="https://formsubmit.co/contact@posted-productions.com"
            method="POST"
          >
            ...
            <div className="flex px-4 md:px-0 flex-col w-[99vw] md:w-[80%]">
              ...
              <textarea
                className="h-[4rem] md:pl-5 md:pt-2  text-black"
                placeholder="required"
                name="message"
                type="text"
                required
            ...
            <div className="px-4 md:px-0 w-[99vw] md:w-[80%]">
              <button
                className="w-full border-2 border-white py-2 px-1 text-xl"
                type="submit"
              >
                Submit
              </button>
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-full h-[41rem] hidden md:block overflow-hidden">
            <iframe
              ...
              className=" w-[75rem] h-[65rem] mt-[-10rem]  object-fill hidden md:flex "
